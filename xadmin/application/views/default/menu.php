                ...
                <ul class="cl">
                    <li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                            ...
                            <li><a href="javascript:;" onclick="product_add('添加教练车','product-add.html')"><i class="Hui-iconfont">&#xe620;</i> 教练车</a></li>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-institution">
            ...
            <dd>
            <ul>
                <li><a data-href="<?php echo base_url('coach/index'); ?>" data-title="培训机构管理" href="javascript:void(0)">培训机构管理</a></li>
                <li><a data-href="<?php echo base_url('coach/index'); ?>" data-title="教练员管理" href="javascript:void(0)">教练员管理</a></li>
                <li><a data-href="<?php echo base_url('trainingcar/index'); ?>" data-title="教练车管理" href="javascript:void(0)">教练车管理</a></li>
                <li><a data-href="<?php echo base_url('institution/list'); ?>" data-title="教练区域管理" href="javascript:void(0)">教练区域管理</a></li>
                <li><a data-href="<?php echo base_url('institution/list'); ?>" data-title="考核员管理" href="javascript:void(0)">考核员管理</a></li>
                <li><a data-href="<?php echo base_url('institution/list'); ?>" data-title="安全员管理" href="javascript:void(0)">安全员管理</a></li>
                <li><a data-href="<?php echo base_url('institution/list'); ?>" data-title="培训时段管理" href="javascript:void(0)">培训时段管理</a></li>
            </ul>
            </dd>
        </dl>
