	...
	<div class="iframe-content">
        ...
        <div class="gx-iframe-content">
            ...
            <div class="gx-iframe-operation" style="margin-bottom: 20px; border-radius: 4px;">
                 <el-button type="success" id="add" @click.active.prevent="handleAdd($event)" data-title="新增广告等级" style="margin-left: 10px;"><i class="el-icon-plus"> 新增广告等级</i></el-button>
            ...
            <el-table :data="list" border tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
				...
				<el-table-column prop="level_id" label="广告等级" width="100" show-overflow-tooltip></el-table-column> 
				<el-table-column prop="level_title" label="标题" min-width="120" show-overflow-tooltip></el-table-column> 
				<el-table-column prop="level_money" label="价格：元" min-width="120" show-overflow-tooltip></el-table-column> 
				<el-table-column prop="loop_time" label="展示时间：秒" min-width="100" show-overflow-tooltip></el-table-column> 
				<el-table-column prop="level_intro" label="广告介绍" min-width="180" show-overflow-tooltip></el-table-column> 
				...
				<el-table-column label="操作" fixed="right" width="140">
					<template scope="scope">
                        ...
                        <a title="编辑" data-title="更新广告等级" style="margin-left:8px;" @click="handleEdit($event, scope.row.id, scope.$index, scope.row)"><i class="el-icon-edit"></i></a>
					</template>
				</el-table-column>
			</el-table>
            </el-table>
...
<script>
	var vm = new Vue({
		...
		data: {
            ...
            list_url: "<?php echo base_url('ads/listAjax')?>?type=level",
            add_url: "<?php echo base_url('ads/addadslevel')?>",
            edit_url: "<?php echo base_url('ads/editads')?>",
            del_url: "<?php echo base_url('ads/delAjax')?>?type=level",
            currentPage: 1,
		...
		methods: {
            ...
            handleEdit: function(e, id, index, row) {
				this.showLayer(e, '60%', 'lb', this.edit_url+'?id='+id+'&type=level');
			},
