<div id="app" v-cloak>
    ...
    <!--表单部分-->
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="200px" class="demo-ruleForm" :label-position="labelPosition">
            <el-form-item label="买家" prop="buyer_name" required>
                <el-col :span="5">
                    <el-input v-model="ruleForm.buyer_name" placeholder="请输入买家" :disabled="true"></el-input>
                </el-col>
            </el-form-item>
...
<script>
    ...
    var vm = new Vue({
        ...
        data: {
            ...
            add_url: "<?php echo base_url('ads/editAjax')?>?type=order",
            ...
            // adsUpload: "<?php echo base_url('ads/adsUpload');?>?tp=ads&unique="+"<?php echo $id?>",
            adsUpload: "<?php echo base_url('upload/handle?type=adsOrder') ?>",
