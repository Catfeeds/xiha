    ...
    <!--表单部分-->
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="200px" class="demo-ruleForm" :label-position="labelPosition">
            ...
            <el-form-item label="省" prop="province_id" required>
                <el-select @change="selectedProvince" v-model="ruleForm.province_id" placeholder="请选择省份">
                    <el-option v-for="item in province_options" :label="item.province" :value="item.provinceid"></el-option>
                </el-select>
            </el-form-item>

            <el-form-item label="市" prop="city_id" required>
                <el-select @change="selectedCity" v-model="ruleForm.city_id" placeholder="请选择城市">
            ...
            <el-form-item label="区" prop="area_id" required>
                <el-select v-model="ruleForm.area_id" placeholder="请选择区域">
...
<script>
    var vm = new Vue({
        ...
        data: {
            ...
            add_url: "<?php echo base_url('ads/addAjax')?>?type=ads",
