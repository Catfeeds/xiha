        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" :label-position="labelPosition">
            ...
            <el-form-item label="更新日志" prop="app_update_log">
                <el-col :span="15">
                    ...
                    <!--<el-input id="app_update_log" type="textarea" v-model="ruleForm.app_update_log" rows="15px" col="15px">-->
                    </el-input>
                </el-col>
            </el-form-item>
...
<script>
    ...
    var force_status = "<?php echo $is_force; ?>";
    var id = "<?php echo $id; ?>";
    var vm = new Vue({
        el: "#app",
        data: {
            ...
            ruleForm: {
                ...
                force_least_updateversion: "<?php echo $force_least_updateversion; ?>",
                os_type: "<?php echo $os_type; ?>",
                app_client: "<?php echo $app_client; ?>",
                is_force: force_status == 0 ? false : true,
                app_update_log: '<?php echo $app_update_log; ?>',
                app_download_url: '<?php echo $app_download_url; ?>',
            },
            rules: {
                app_name: [
            ...
            edit_url: "<?php echo base_url('app/editAjax')?>",
