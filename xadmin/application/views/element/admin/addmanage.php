    ...
    <div class="iframe-content" style="margin-top: 30px;">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" :label-position="labelPosition">
            ...
            <el-form-item label="手机号" prop="phone" required>
                <el-col :span="10">
                    <el-input v-model="ruleForm.phone" placeholder="请输入手机号，如：18756004206"></el-input>
                <el-col>
            </el-form-item>
            ...
            <el-form-item label="所属角色" prop="role_info" required>
                <el-col :span="10" style="position:relative;">
                    <el-select v-model="ruleForm.role_info" clearable placeholder="请选择角色">
                        <el-option v-for="item in roles_list" :label="item.s_rolename" :value="item.l_role_id+'|'+item.s_rolename"></el-option>
                    </el-select>
                </el-col>
                <el-col :span="11" style="margin-left: 10px;">
                    ...
                    <el-dialog title="添加角色" v-model="dialogFormVisible">
                        <el-form :model="tagForm" :rules="tagRules" ref="tagForm" label-width="100px" class="demo-ruleForm" :label-position="labelPosition">
                            <el-form-item label="角色名称" prop="s_rolename" label-width="100" required>
                                <el-input v-model="tagForm.s_rolename" placeholder="请输入角色名称 如后台编辑"></el-input>
                            </el-form-item>
...
<script>
    var vm = new Vue({
        ...
        data: {
            ...
            base_url: "<?php echo base_url('admin/addManageAjax'); ?>",
