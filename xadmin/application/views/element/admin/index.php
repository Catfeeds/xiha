<div id="app" v-cloak>
    <div class="iframe-content" style="margin-top: 10px;">
        ...
        <el-row :gutter="0" style="">
            <el-col :span="4" style="background: rgb(51, 204, 204);" >
                <div class="grid-content bg-purple" style=" padding: 20px 0px; border-right: 1px solid #fff; color: #fff; text-align:center; margin: 20px 0px;">
                    <p style="font-size:20px;">30单/天</p> <br>
                    <span style="font-size:16px;">报名班制订单</span>
                </div>
            </el-col>
            <el-col :span="4" style="background: rgb(51, 204, 204);" >
                <div class="grid-content bg-purple" style=" padding: 20px 0px; border-right: 1px solid #fff; color: #fff; text-align:center; margin: 20px 0px;">
                    <p style="font-size:20px;">100单/天</p> <br>
                    <span style="font-size:16px;">预约计时订单</span>
                </div>
            </el-col>
            <el-col :span="4" style="background: rgb(51, 204, 204);" >
                <div class="grid-content bg-purple" style=" padding: 20px 0px; color: #fff; text-align:center; margin: 20px 0px;">
                    <p style="font-size:20px;">30人</p> <br>
                    <span style="font-size:16px;">教练认证申请</span>
                </div>
            </el-col>
            <el-col :span="4" style="background: #ff4949;" >
                <div class="grid-content bg-purple" style=" padding: 20px 0px; color: #fff; text-align:center; margin: 20px 0px;">
                    <p style="font-size:20px;">3单</p> <br>
                    <span style="font-size:16px;">申请退款</span>
                </div>
            </el-col>
            <el-col :span="8" style="" >
                <div class="grid-content bg-purple" style="background: rgb(48, 145, 242); padding: 40px 0px; margin-left: 20px; color: #fff; text-align:center;">
                    <p style="font-size:20px;">300人</p> <br>
                    <span style="font-size:16px;">今日学员数</span>
                </div>
            </el-col>
        </el-row>
