<div id="app" v-cloak>
    ...
    <!--表单部分-->
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" :label-position="labelPosition">
            <el-form-item label="驾校名称" prop="school_name" v-if="school_id == 0" required>
                <el-col :span="11">
...
<script>
    ...
    var open_status = "<?php echo $site_status;?>";
    var vm = new Vue({
        el: "#app",
        data: {
            labelPosition: 'right',
            ...
            ruleForm: {
                ...
                open_status: open_status == 1 ? true : false,
                province_id: "<?php echo $province;?>",
                city_id: "<?php echo $city;?>",
                area_id: "<?php echo $area;?>",
                s_address: "<?php echo $address;?>",
                point_url_one: "<?php echo $point_text_url1;?>",
                point_url_two: "<?php echo $point_text_url2;?>",
                resource_url: "<?php echo $model_resource_url;?>",
                site_imgurl: "<?php echo $imgurl;?>",
                siteimgurl: "<?php echo $http_imgurl?>",
                site_desc: "<?php echo $site_desc;?>",
            },
            rules: {
                school_id: [
            ...
            edit_url: "<?php echo base_url('school/editSiteAjax')?>",
