        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" :label-position="labelPosition">
            ...
            <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
                <el-tab-pane label="基本信息" name="first">
                    ...
                    <el-form-item prop="coach_name" label="教练名称" v-if="school_id != ''">
                        <el-select
                            v-model="ruleForm.coach_name"
                            filterable
                            remote
...
<script>
    ...
    var is_package = "<?php echo $is_package; ?>";
    ...
    var vm = new Vue({
        ...
        data: {
            ...
            ruleForm: { 
                id:                 "<?php echo $id; ?>",
                sh_school_id:       "<?php echo $sh_school_id; ?>",
                coach_id:           "<?php echo $coach_id; ?>",
                coach_name:         "<?php echo $s_coach_name; ?>",
                school_name:        "<?php echo $s_school_name; ?>",
                sh_title:           "<?php echo $sh_title; ?>",
                sh_money:           "<?php echo $sh_money; ?>",
                sh_original_money:  "<?php echo $sh_original_money; ?>",
                sh_type:            "<?php echo $sh_type; ?>",
                sh_description_1:   "<?php echo $sh_description_1; ?>",
                sh_license:         "<?php echo $sh_license_id.'|'.$sh_license_name; ?>",
                sh_license_id:      "<?php echo $sh_license_id; ?>",
                sh_license_name:    "<?php echo $sh_license_name; ?>",
                sh_tag_info:        "<?php echo $sh_tag_id.'|'.$sh_tag; ?>",
                sh_tag:             "<?php echo $sh_tag; ?>",
                sh_tag_id:          "<?php echo $sh_tag_id; ?>",
                order:              "<?php echo $order; ?>",
                is_promote:         is_promote == 1 ? true : false,
                coupon_id:          "<?php echo $coupon_id; ?>",
                sh_info:            "<?php echo htmlspecialchars($sh_info); ?>",
                sh_description_2:   "<?php echo htmlspecialchars($sh_description_2); ?>",
                is_package:         is_package == 1 ? true : false,
                deleted:            deleted == 1 ? true : false,
                iscoach: parseInt(coach_id) ? true : false,
                iscoupon: parseInt(coupon_id) == 0 ? false : true,
                sh_imgurl:          "",
                schoolshifts:       "<?php echo $imgurl; ?>",
            },
            rules: {
                sh_school_id: [
            ...
            base_url: "<?php echo base_url('school/editshiftsajax'); ?>",
