<div id="app" v-cloak>
    ...
    <!--表单部分-->
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="200px" class="demo-ruleForm" :label-position="labelPosition">
            <el-form-item label="所属驾校" v-if="school_id == ''" required>
            ...
            <el-form-item label="时间设置" prop="time_list" required>
                <el-table :data="list" border tooltip-effect="dark" style="width: 60%" @selection-change="handleSelectionChange">
...
<script>
    ...
    var vm = new Vue({
        ...
        data: {
            ...
            add_url: "<?php echo base_url('systems/addAjax')?>?type=sconf",
            ssearch_url: "<?php echo base_url('systems/searchAjax')?>?type=school",
            time_url: "<?php echo base_url('systems/timelistAjax')?>",
        },
        created: function() {
            this.timelistAjax();
        },
