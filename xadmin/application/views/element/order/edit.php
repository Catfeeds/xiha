    ...
    <div class="iframe-content">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" :label-position="labelPosition">
            ...
            <el-form-item prop="so_school_id" label="所属驾校" v-if="school_id == ''" required>
                <el-col :span="6">
                    <el-input v-model="ruleForm.school_name"  :disabled="true" placeholder="请输入身份证号码"></el-input>
                </el-col>
            </el-form-item>
            ...
            <el-form-item label="订单状态" prop="pay_type">
                <el-radio-group size="small" v-model="ruleForm.pay_type">
                    ...
                    <el-radio-button :label="pay_type_text"></el-radio-button>
                </el-radio-group>
            </el-form-item>
            <el-form-item label="支付状态" prop="order_status">
                <el-radio-group size="small" v-model="ruleForm.order_status">
                    ...
                    <el-radio-button :label="order_status_text"></el-radio-button>
                </el-radio-group>
            </el-form-item>
...
<script>
    ...
    var sid = "<?php echo $so_school_id?>";
    var pay_type = "<?php echo $so_pay_type; ?>";
    var order_status = "<?php echo $so_order_status; ?>";
    var order_status_text = "<?php echo $order_status_text; ?>";
    var pay_type_text = "<?php echo $pay_type_text; ?>";
    var vm = new Vue({
        el: "#app",
        data: {
            labelPosition: 'right',
            ...
            ruleForm: {
                id: "<?php echo $id; ?>",
                user_id: "<?php echo $so_user_id;?>",
                user_name: "<?php echo $so_username; ?>",
                school_name: "<?php echo $school_name; ?>",
                user_phone: "<?php echo $so_phone; ?>",
                license: "<?php echo $so_licence; ?>",
                identity_id: "<?php echo $so_user_identity_id; ?>",
                so_school_id: sid,
                so_shifts_id: "<?php echo $so_shifts_id; ?>",
                free_study_hour: "<?php echo $free_study_hour; ?>",
                original_price: "<?php echo $so_original_price; ?>",
                final_price: "<?php echo $so_final_price; ?>",
                total_price: "<?php echo $so_total_price; ?>",
                pay_type: "<?php echo $pay_type_text; ?>",
                order_status: "<?php echo $order_status_text; ?>",
                order_no: "<?php echo $so_order_no; ?>",
            },
            rules: {
                user_name: [
            ...
            errorClass: 'error',
            base_url: "<?php echo base_url('order/editajax'); ?>",
