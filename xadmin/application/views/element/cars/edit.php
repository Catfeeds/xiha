<div id="app" v-cloak>
    ...
    <!--表单部分-->
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" :label-position="labelPosition" enctype="multipart/form-data">
            <el-form-item label="驾校名称" prop="school_id" v-if="l_school_id == 0" required>
                <el-select
...
<script>
    var l_school_id = "<?php echo $l_school_id; ?>";
    var vm = new Vue({
        el: "#app",
        data: {
            labelPosition: 'right',
            ...
            ruleForm: {
                ...
                car_cate_id: '<?php echo $car_cate_id; ?>',
                cate_name: '<?php echo $cate_name; ?>',
                imgurl_one: '<?php echo $imgurl_one; ?>',
                coachCarsOne: '<?php echo $http_imgurl_one; ?>',
                imgurl_two: '<?php echo $imgurl_two; ?>',
                coachCarsTwo: '<?php echo $http_imgurl_two; ?>',
                imgurl_three: '<?php echo $imgurl_three; ?>',
                coachCarsThree: '<?php echo $http_imgurl_three; ?>',
            },
            rules: {
                school_id: [
            ...
            carcate_list: [],
            edit_url: "<?php echo base_url('cars/editAjax')?>?type=coachcar",
