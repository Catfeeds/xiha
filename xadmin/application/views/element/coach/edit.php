        ...
        <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
            <el-tab-pane label="基本信息" name="first">
                ...
                <el-form-item label="驾校名称" prop="school_id" v-if="school_id == 0" required>
                    <el-col span="8">
                        <el-input v-model="ruleForm.s_school_name" :disabled="true"></el-input>
                    </el-col>
                    <!-- <el-select
...
<script>
    ...
    var order_receive_status = "<?php echo $order_receive_status; ?>";
    var is_elecoach = "<?php echo $is_elecoach; ?>";
    var coupon_supported = "<?php echo $coupon_supported; ?>";
    var timetraining_supported = "<?php echo $timetraining_supported; ?>";
    var must_bind = "<?php echo $must_bind; ?>";
    var vm = new Vue({
        el: "#app",
        data: {
            errorClass: 'error',
            ...
            ruleForm: {
                l_coach_id: "<?php echo $l_coach_id; ?>",
                school_id: "<?php echo $s_school_name_id; ?>",
                s_coach_name: "<?php echo $s_coach_name; ?>",
                s_coach_phone: "<?php echo $s_coach_phone; ?>",
                s_teach_age: "<?php echo $s_teach_age; ?>",
                i_coach_star: "<?php echo $i_coach_star; ?>",
                average_license_time: "<?php echo $average_license_time; ?>",
                lesson2_pass_rate: "<?php echo $lesson2_pass_rate; ?>",
                lesson3_pass_rate: "<?php echo $lesson3_pass_rate; ?>",
                s_coach_sex: "<?php echo $s_coach_sex; ?>",
                s_coach_imgurl: "<?php echo $s_coach_imgurl; ?>",
                coachimg: "<?php echo $http_coach_imgurl;?>",
                s_school_name: "<?php echo $s_school_name; ?>",
                s_coach_car_id: "<?php echo $s_coach_car_id; ?>",
                s_coach_lesson_id: ["<?php echo $coach_lesson; ?>"],
                s_coach_lisence_id: ["<?php echo $coach_license; ?>"],
                province_id: "<?php echo $province_id; ?>",
                city_id: "<?php echo $city_id; ?>",
                area_id: "<?php echo $area_id; ?>",
                s_coach_address:"<?php echo $s_coach_address; ?>",
                i_type: "<?php echo $i_type; ?>",
                is_hot: is_hot == 1 ? true : false,
                order_receive_status: order_receive_status == 1 ? true : false,
                is_elecoach: is_elecoach == 1 ? true : false,
                coupon_supported: coupon_supported == 1 ? true : false,
                timetraining_supported: timetraining_supported == 1 ? true : false,
                must_bind: must_bind == 1 ? true : false,
            ...
            base_url: "<?php echo base_url('coach/editAjax')?>",
