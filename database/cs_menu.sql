...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-01-04 02:02:23
-- 服务器版本： 5.7.9
-- PHP Version: 5.6.15
...
(219, 1, 92, '798819', 'Coach/coachUserRelation', 1, '教练绑定列表', '教练和学员绑定关系列表', '', 104, 1),
(220, 1, 219, '798981', 'Coach/coachUserRelation', 2, '查看', '查看教练绑定列表', '', 100, 1),
(221, 1, 219, '287115', 'Coach/setCoachBindStatus', 2, '设置', '设置教练的绑定状态', '', 100, 1),
...
(235, 1, 230, '490793', 'City/setHotStatus', 2, '设置', '设置城市热门状态', '', 1005, 1);
