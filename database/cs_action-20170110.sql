...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-01-10 09:01:52
-- 服务器版本： 5.7.9
-- PHP Version: 5.6.15
...
CREATE TABLE IF NOT EXISTS `cs_action` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=161 DEFAULT CHARSET=utf8 COMMENT='系统行为表' ROW_FORMAT=DYNAMIC;
...
(159, 'set_training_support_status', '设置教练的支持培训状态', '设置教练的支持培训状态', '', '[user|getOperator]在[time|time_format]设置了教练的支持培训状态', 1, 1, 1484014854, 0),
(160, 'set_coach_time_config', '设置教练的时间配置', '设置教练的时间配置', '', '[user|getOperator]在[time|time_format]设置了教练的时间配置', 1, 1, 1484038592, 0);
