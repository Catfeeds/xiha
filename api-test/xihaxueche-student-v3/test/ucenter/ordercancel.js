...
describe('/student/order/cancel', function () {
    const api = prefix + '/student/order/cancel';
    ...
    describe('business here', function () {
    	...
    	it('should match correct json schema', function () {
            ...
            var cancel_reason = '信息填写失误';
            var args = {token:token,order_type:order_type,order_id:order_id,order_no:order_no,cancel_reason:cancel_reason};
