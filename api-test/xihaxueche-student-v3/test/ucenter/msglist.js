...
describe('/student/ucenter/message/list', function () {
    const api = prefix + '/student/ucenter/message/list';
    ...
    describe('business here', function () {
    	...
    	it('should match correct json schema', function () {
    		...
    		var page = 1;
            var response = chakram.get(api + '?&token=' + token + '&message_type=' + message_type + '&page=' + page);
                                    ...
                                    "properties":{
                                        "data":{
                                            ...
                                            "items": {
                                                ...
                                                "required":["id","beizhu","is_read","addtime","content","push_time"]
                                            }
                                        }
                                    },
                                    "required":["data"]
