...
class Controller extends Object
{
     ...
     * @return void
     */
    public function illegalForm(){
        echo "禁止非法提交表单，你的IP:".Chips::getIP()."已被记录在案，时间：".date("Y-m-d")."。";
    }
     /**
      * 登录验证动作
      *
     ...
     * @return void
     */
    public function checkFormToken($return=false){
        if(!$this->getModule()->checkToken('form')){
            if($return){
                return false;
            }else{
                $this->illegalForm();
