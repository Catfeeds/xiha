...
class Menu
{
    ...
    public function __construct()
    {
        ...
        '/order/order_log_list'=>array('name'=>'订单日志','parent'=>'order'),
        '/order/payment_log_list'=>array('name'=>'支付日志','parent'=>'order'),
        '/order/payment_log_tongji'=>array('name'=>'收支统计','parent'=>'order'),
