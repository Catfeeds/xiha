    ...
    <div class="mui-content" style="padding-top: 0px; overflow: scroll; width: 100%; height: 100%;">
	    ...
	    <div class="xiha-content" style="margin-top: 0px;">
	    	<div class="mui-row">
		        <div class="mui-col-sm-6 mui-col-xs-6" @tap="redirect('article', 1)">
		            <li class="mui-table-view-cell">
	            		<img style="width: 155px;" src="<?php echo base_url('assets/images/keyikaogui@2x.png') ?>"/> 
		            </li>
		        </div>
	    ...
	    <div class="xiha-content" style="padding: 10px 0px;">
	    	<div class="mui-row">
		        <div class="mui-col-sm-4 mui-col-xs-4">
		        	<ui>
			            <li class="mui-table-view-cell" @click="handleQues('home/question', 3)">
		        ...
		        <div class="mui-col-sm-4 mui-col-xs-4">
		            <ui>
			            <li class="mui-table-view-cell" @click="jump('home/special', currentSubjectid, 0)">
		            		<img style="height: 45px; width: 45px;" src="<?php echo base_url('assets/images/zhuanxianglianxi@2x.png') ?>"/> 
		            		<p>专项练习</p>
			            </li>
			            <li class="mui-table-view-cell" @click="jump('home/chapter', currentSubjectid, 0)">
    	...
    	<div class="xiha-content" style="margin-top: 1px; padding: 10px 0px;">
	    	<div class="mui-row">
		        <div class="mui-col-sm-4 mui-col-xs-4">
		        	<ui>
			            <li class="mui-table-view-cell" @click="jump('home/rank', currentSubjectid, 0)">
		        ...
		        <div class="mui-col-sm-4 mui-col-xs-4">
		            <li class="mui-table-view-cell" style="margin-top: 35px; padding: 0px;" @click="jump('home/exam', currentSubjectid, 0)">
		        ...
		        <div class="mui-col-sm-4 mui-col-xs-4">
		            <ui>
			            <li class="mui-table-view-cell" @click="jump('home/sprint', currentSubjectid, 0)">
...
<script type="text/javascript">
    var vm = new Vue({
        ...
        created: function() {
        	this.lessonList[0].isChoose = true;
    		this.initAjax();
        },
        methods: {
        	initAjax: function() {
        		...
        		mui.ajax(this.init_url, {
                     ...
                     success:function(data){
                         if(data.code == 200) {
                             vm.tiku_num = data.data.kemu1_count;
                         } else {
                             mui.toast(data.msg)
                         }
                     },
