<style>
	...
	.mui-table-view-cell:after {height: 1px;}
    ...
    <div class="mui-content" style="padding-top: 0px; overflow: scroll; width: 100%; height: 100%;">
	    ...
	    <div class="xiha-content" style="margin-top: 0px;">
	    	<div class="mui-row">
		        ...
		        <div class="mui-col-sm-6 mui-col-xs-6">
		            <li class="mui-table-view-cell" style="padding-bottom: 5px;">
	            		<img style="width: 155px;" src="<?php echo base_url('assets/images/kesanmiji@2x.png') ?>"/> 
		            </li>
		        </div>
		        <div class="mui-col-sm-6 mui-col-xs-6">
		            <li class="mui-table-view-cell">
	            		<img style="width: 155px;" src="<?php echo base_url('assets/images/xuechebaogao@2x.png') ?>"/> 
		            </li>
		        </div>
		        <div class="mui-col-sm-6 mui-col-xs-6">
		            <li class="mui-table-view-cell">
	            		<img style="width: 155px;" src="<?php echo base_url('assets/images/dianzijiaolian@2x.png') ?>"/> 
		            </li>
		        </div>
	    	</div>
	    </div>
...
<script type="text/javascript">
    var vm = new Vue({
        ...
        created: function() {
        	this.lessonList[2].isChoose = true;
         	this.videoAjax();
        },
        methods: {
        	videoAjax: function() {
