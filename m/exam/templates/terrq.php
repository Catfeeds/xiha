...
<html>
    <head>
        ...
        <title>模拟错题-牌照<?php echo $ctype; ?>-科目<?php echo $stype; ?></title>
    ...
    <body style="background: #f5f5f5;">
        ...
        <header class="mui-bar mui-bar-nav">
            ...
            <h1 class="mui-title" id="title">模拟错题</h1>
        </header>
        <?php } ?>
        ...
        <script>
			...
			var errq = localStorage.getItem('errq__') ? JSON.parse(localStorage.getItem('errq__')) : [];
			console.log(errq);
        </script>
        ...
        <script src="<?php echo $root_path; ?>/assets/js/exam/errq.js?=<?php echo $r; ?>"></script>
    </body>
</html>
