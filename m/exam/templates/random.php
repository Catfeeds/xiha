...
<html>
    <head>
        ...
        <title>随机练习-牌照<?php echo $ctype; ?>-科目<?php echo $stype; ?></title>
    ...
    <body style="background: #f5f5f5;">
        ...
        <header class="mui-bar mui-bar-nav">
            ...
            <h1 class="mui-title" id="title">随机练习</h1>
        </header>
        <?php } ?>
        ...
        <script src="<?php echo $root_path; ?>/assets/js/exam/random.js?=<?php echo $r; ?>"></script>
    </body>
</html>
