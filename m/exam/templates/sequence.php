...
<html>
    <head>
        ...
        <title>顺序练习-牌照<?php echo $ctype; ?>-科目<?php echo $stype; ?></title>
    ...
    <body style="background: #f5f5f5;">
        ...
        <header class="mui-bar mui-bar-nav">
            ...
            <h1 class="mui-title" id="title">顺序练习</h1>
            <span class="mui-btn mui-btn-link mui-pull-right" style="margin-left: 10px; color: #56abe4; ">
            	<span class="iconfont" style="font-size:1.2rem;">&#xe638;</span>
                <span id="cacheall">一键缓存</span>
            </span>
        </header>
    	<?php } ?>
        ...
        <!--<script src="<?php echo $root_path; ?>/assets/js/alasql.min.js"></script>-->
        ...
        <script src="<?php echo $root_path; ?>/assets/js/exam/sequence.js?=<?php echo $r; ?>"></script>
        <!--<script src="<?php echo $root_path; ?>/assets/js/indexedDB.js"></script>-->
    </body>
</html>
