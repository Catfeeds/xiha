        ...
        <div id="slider" class="mui-slider" style="">
          <div id="sliderSegmentedControl" style="margin-top:10px;">
            ...
            <div id="second" style="float:left;text-align:center;  width:29%;">
              <a class="mui-control-item" href="#item2mobile"  style="text-align:center;color:#333;font-size:15px;font-style:Microsoft YaHei" >右出库</a>
            </div >
            <div id="third" style="float:left;text-align:center;width:14%; ">
              <a class="mui-control-item" href="#item3mobile"  style="text-align:center;color:#333;font-size:15px;font-style:Microsoft YaHei">出库</a>
            </div>
             <div id="four" style="float:left;text-align:center;width:29%; ">
              <a class="mui-control-item" href="#item4mobile"  style="text-align:center;color:#333;font-size:15px;font-style:Microsoft YaHei">左倒库</a>
            </div>
             <div id="five" style="float:right;text-align:center;width:14%; ">
              <a class="mui-control-item" href="#item5mobile"  style="text-align:center;color:#333;font-size:15px;font-style:Microsoft YaHei">出库</a>
            </div>
          </div>
          ...
          <div class="mui-slider-group" >
            <div id="item1mobile" class="mui-slider-item  mui-active">
              <div id="scroll1" class="mui-scroll-wrapper">
                  <div class="mui-scroll">
                      <ul>
                        <li><img src="../assets/images/ecoach/garagecar1.png"  text-align="center"  /></li>
            ...
            <div id="item2mobile" class="mui-slider-item " style="display:none">
              <div class="mui-scroll-wrapper">
                  <div class="mui-scroll">
                      <ul >
                          <li><img src="../assets/images/ecoach/garagecar2.1.png"  text-align="center"  /></li>
                          <li><img src="../assets/images/ecoach/garagecar2.2.png"  text-align="center"  /></li>
                          <li><img src="../assets/images/ecoach/garagecar2.3.png"  text-align="center"  /></li>
                          <li><img src="../assets/images/ecoach/garagecar2.4.png"  text-align="center"  /></li>
                          <li><img src="../assets/images/ecoach/garagecar2.5.png"  text-align="center"  /></li>
                          <li><img src="../assets/images/ecoach/garagecar2.6.png"  text-align="center"  /></li>
              ...
              <div class="mui-scroll-wrapper">
                  <div class="mui-scroll">
                      <ul style="list-style:none;">                                    
                          <li ><img src="../assets/images/ecoach/garagecar3.1.png"  text-align="center"  /></li>
                          <li ><img src="../assets/images/ecoach/garagecar3.2.png"  text-align="center"  /></li>
            ...
            <div id="item4mobile" class="mui-slider-item " style="display:none">
              <div class="mui-scroll-wrapper">
                  <div class="mui-scroll">
                    <ul>
                      <li ><img src="../assets/images/ecoach/garagecar4.1.png"  text-align="center"  /></li>
                      <li ><img src="../assets/images/ecoach/garagecar4.2.png"  text-align="center"  /></li>
                      <li ><img src="../assets/images/ecoach/garagecar4.3.png"  text-align="center"  /></li>
                      <li ><img src="../assets/images/ecoach/garagecar4.4.png"  text-align="center"  /></li>
                      <li ><img src="../assets/images/ecoach/garagecar4.5.png"  text-align="center"  /></li>
            ...
            <div id="item5mobile" class="mui-slider-item " style="display:none">
              <div class="mui-scroll-wrapper">
                  <div class="mui-scroll">
                      <ul >
                        <li ><img src="../assets/images/ecoach/garagecar5.1.png"  text-align="center"  /></li>
                        <li ><img src="../assets/images/ecoach/garagecar5.2.png"  text-align="center"  /></li>
