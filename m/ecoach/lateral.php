        ...
        <div id="slider" class="mui-slider" style="">
          <div id="sliderSegmentedControl" style="margin-top:10px;">
            ...
            <div id="second" style="float:left;text-align:center;  width:72%;">
              <a class="mui-control-item" href="#item2mobile"  style="text-align:center;color:#333;font-size:15px;font-style:Microsoft YaHei" >倒车</a>
            </div >
          ...
          <div class="mui-slider-group" >
            <div id="item1mobile" class="mui-slider-item  mui-active">
              <div id="scroll1" class="mui-scroll-wrapper">
                  <div class="mui-scroll">
                      <ul>
                        <li><img src="../assets/images/ecoach/stopcar1.png"  text-align="center"  /></li>
            ...
            <div id="item2mobile" class="mui-slider-item " style="display:none">
              <div class="mui-scroll-wrapper">
                  <div class="mui-scroll">
                      <ul >
                          <li><img src="../assets/images/ecoach/stopcar2.1.png"  text-align="center"  /></li>
                          <li><img src="../assets/images/ecoach/stopcar2.2.png"  text-align="center"  /></li>
                          <li><img src="../assets/images/ecoach/stopcar2.3.png"  text-align="center"  /></li>
                          <li><img src="../assets/images/ecoach/stopcar2.4.png"  text-align="center"  /></li>
              ...
              <div class="mui-scroll-wrapper">
                  <div class="mui-scroll">
                      <ul style="list-style:none;">                                    
                          <li ><img src="../assets/images/ecoach/stopcar3.1.png"  text-align="center"  /></li>
                          <li ><img src="../assets/images/ecoach/stopcar3.2.png"  text-align="center"  /></li>
