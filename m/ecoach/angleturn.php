        ...
        <div id="slider" class="mui-slider" style="">
          <div id="sliderSegmentedControl" style="margin-top:10px;">
            ...
            <div id="second" style="float:left;text-align:center;  width:72%;">
              <a class="mui-control-item" href="#item2mobile"  style="text-align:center;color:#333;font-size:15px;font-style:Microsoft YaHei" >转弯</a>
            </div >
            <div id="third" style="float:left;text-align:center;width:14%; ">
              <a class="mui-control-item" href="#item3mobile"  style="text-align:center;color:#333;font-size:15px;font-style:Microsoft YaHei">出口</a>
            </div>
          </div>
          ...
          <div class="mui-slider-group" >
            <div id="item1mobile" class="mui-slider-item  mui-active">
              <div id="scroll1" class="mui-scroll-wrapper">
                  <div class="mui-scroll">
                      <ul>
                        <li><img src="../assets/images/ecoach/starting.png"  text-align="center"  /></li>
            ...
            <div id="item2mobile" class="mui-slider-item " style="display:none">
              <div class="mui-scroll-wrapper">
                  <div class="mui-scroll">
                      <ul >
                          <li><img src="../assets/images/ecoach/starting2.png"  text-align="center"  /></li>
                          <li id="item2" style="margin-bottom:130px;"><a href="#item3mobile"  style='padding:10px 0px; border:none; background: #7dd3c0;' class='mui-btn mui-btn-block mui-btn-success'>下一步</a></li>
                      </ul>
                  </div>
              </div>
            </div>
              ...
              <div class="mui-scroll-wrapper">
                  <div class="mui-scroll">
                      <ul style="list-style:none;">                                    
                          <li ><img src="../assets/images/ecoach/starting3.png"  text-align="center"  /></li>
