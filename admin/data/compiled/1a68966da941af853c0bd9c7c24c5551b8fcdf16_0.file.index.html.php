<?php /* Smarty version 3.1.27, created on 2016-06-28 18:35:17
         compiled from "D:\wlwork\php\admin\templates\admin\index.html" */ ?>
<?php
/*%%SmartyHeaderCode:9957577252e5aac3b6_43180705%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1a68966da941af853c0bd9c7c24c5551b8fcdf16' => 
    array (
      0 => 'D:\\wlwork\\php\\admin\\templates\\admin\\index.html',
      1 => 1464060764,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9957577252e5aac3b6_43180705',
  'variables' => 
  array (
    'name' => 0,
    'manage_config' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_577252e5bbdaf2_60353958',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_577252e5bbdaf2_60353958')) {
function content_577252e5bbdaf2_60353958 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '9957577252e5aac3b6_43180705';
echo $_smarty_tpl->getSubTemplate ("library/header_admin.lbi", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0);
?>
    ...
    <div class="mainer">
        <div class="admin-navbar">
            <span class="float-right">
                <span style="color:#fff;">您好，<?php echo $_smarty_tpl->tpl_vars['name']->value;?>
，欢迎您的光临。</span>
                <!-- <a class="button button-little bg-main" href="http://www.pintuer.com" target="_blank">个人信息</a> -->
                <a class="button button-lg bg-yellow" href="index.php?action=admin&op=logout">注销登录</a>
            </span>
...
?>
                <li <?php if ($_smarty_tpl->tpl_vars['key']->value == 1) {?>class="active"<?php }?>>
                    <a href="javascript:;" class="admin-nav-a" onclick="javascript:redirecttopurl('<?php echo $_smarty_tpl->tpl_vars['value']->value['controll'];?>
', '<?php echo $_smarty_tpl->tpl_vars['value']->value['function'];?>
', this)" ><i class="iconfont"><?php echo $_smarty_tpl->tpl_vars['value']->value['content'];?>
</i> <?php echo $_smarty_tpl->tpl_vars['value']->value['bigcate_name'];?>
</a>
                    <ul class="cate_ul">
                        <?php
...
?>
                         <li>
                            <a href="javascript:;" onclick="javascript:redirecturl('<?php echo $_smarty_tpl->tpl_vars['v']->value['controll'];?>
','<?php echo $_smarty_tpl->tpl_vars['v']->value['function'];?>
', this)">
                                <i class="iconfont" style="padding-right:15px; color:#ccc"><?php echo $_smarty_tpl->tpl_vars['v']->value['content'];?>
</i> 
...
?>
                         <!-- <div class="collapse"><div class="panel"> <div class="panel-head"><h4>...</h4></div> <div class="panel-body">...</div> </div></div> -->
                    </ul>
                </li>
                <?php
...
?>
   ...
   <!--      <div class="admin-bread">
            <ul class="bread">
                <li><a href="javascript:;" class="nav_crumbs"> 开始</a></li>
...
<!-- 右侧显示区域start -->
<div class="admin">
    <iframe name="right" id="rightMain" src="index.php?action=school&op=index" frameborder="false" scrolling="auto" style="border:none; margin-bottom:0px;" width="100%" height="100%" allowtransparency="true"></iframe>
</div>
<!-- 右侧显示区域end -->
<?php echo '<script'; ?>
 type="text/javascript">
