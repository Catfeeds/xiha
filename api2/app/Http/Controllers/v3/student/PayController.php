...
use App\Http\Controllers\v1\student\WechatpayController; // pay_type = 3
use App\Http\Controllers\v1\student\AlipayController; // pay_type = 1
use App\Http\Controllers\v1\student\UnionpayController; // pay_type = 4
use App\Http\Controllers\v1\student\PusherController;
use App\Http\Controllers\v1\student\OrderController;
use App\Http\Controllers\v1\student\SmsController as Sms; // 短信
