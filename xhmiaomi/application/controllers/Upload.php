...
class Upload extends CI_Controller {
    ...
    public function handle()
    {
        ...
        else
        {
            ...
            $this->output->set_content_type('application/json')
                         ->set_output(json_encode(['code' => 200, 'msg' => 'upload ok', 'data' => ['file_id' => $file_id, 'type'=>$type, 'url'=>'upload/'.$_relative_path, 'file_url' => base_url('upload/'.$_relative_path)]]))
                         ->_display();
            exit();
        }
    }
    ...
    protected function _save_path($field = NULL, $path = '')
    {
        ...
        $this->db->insert('mi_filedata', $_data);
