	...
	<div class="iframe-content">
		...
		<div class="gx-iframe-content">
			...
			<el-table :data="list" border tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange" >
				...
				<el-table-column prop="s_role_name" label="角色名称" width="160" show-overflow-tooltip></el-table-column> 
				...
				<el-table-column label="操作" fixed="right" width="145">
					<template scope="scope">
						...
						<el-button size="small" type="text" data-title="更新信息" @click.native.prevent="handleEdit($event, scope.row.l_role_id, scope.$index, scope.row)"><i class="el-icon-edit"></i></el-button>
					</template>
				</el-table-column>
			</el-table>
...
<script>
	...
	var vm = new Vue({
		...
		data: {
			...
			list: [],
			multipleSelection: [],
			list_url: "<?php echo base_url('admin/rolesAjax'); ?>",
