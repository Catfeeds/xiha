<?php 
    ...
    define('DBPREFIX', 'cs_');
    define('MOBILEPATH', '../m/');
    define('S_HTTP_HOST', 'http://192.168.100.65/php/sadmin/');
    define('HTTP_HOST', 'http://192.168.100.65/php/admin/');
    define('HOST', 'http://192.168.100.65/php/');
    define('HOST_URL', 'http://192.168.100.65/');
    define('SHOST', 'http://192.168.100.65/php/');
