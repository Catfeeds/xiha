...
<body>
	<div align="center">
        <ul>
            <li style="background-color:#FF7F24"><a href="http://api.xihaxueche.com/service/WxpayAPI_php_v3/example/jsapi.php">JSAPI支付</a></li>
            <li style="background-color:#698B22"><a href="http://60.173.247.68:8081/WxpayAPI_php_v3/example/micropay.php">刷卡支付</a></li>
