<form class="api-form" method="post" action="../../apppay/unipay/return_url.php" target="_blank">
<p>
<label>商户号：</label>
...
<p>
<label>交易金额：</label>
<input id="txnAmt" type="text" name="order_money" placeholder="交易金额" value="1000" title="单位为分 " required="required"/>
</p>
<p>
<label>订单发送时间：</label>
<input id="txnTime" type="text" name="order_time" placeholder="订单发送时间，YYYYMMDDhhmmss格式" value="<?php echo date('YmdHis')?>" title="取北京时间" required="required"/>
</p>
<p>
<label>商户订单号：</label>
<input id="orderId" type="text" name="order_no" placeholder="商户订单号" value="<?php echo date('YmdHis')?>" title="自行定义，8-32位数字字母 " required="required"/>
</p>
<p>
<label>&nbsp;</label>
