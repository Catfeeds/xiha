...
$(function(){
	...
	// 	setCookie("Huiskin", v);
	// 	$("#skin").attr("href","__PUBLIC__/Home/assets/skin/"+v+"/skin.css");
	// 	$(window.frames.document).contents().find("#skin").attr("href","__PUBLIC__/Home/assets/skin/"+v+"/skin.css");
	// });

	/*全选*/
	$("#system_pmtimeconf thead th input:checkbox").on("click" , function(){
		$(this).closest("table").find("tr > td:first-child input:checkbox").prop("checked",$("#system_pmtimeconf thead th input:checkbox").prop("checked"));
    });
}); 
