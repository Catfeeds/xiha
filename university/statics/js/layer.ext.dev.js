    ...
    q.event = function() {
        ...
        if(isSupportTouch){
        	...
        	if(typeof touch === "undefined"){
                layer.use("touch.min.js"/*tpa=http://www.ahu.edu.cn/_js/_portletPlugs/wp_photos/layer/extend/extend/touch.min.js*/,function(){
                    q.touch();
                });
            }else{
                q.touch();
...
layer.use("layer.ext.css"/*tpa=http://www.ahu.edu.cn/_js/_portletPlugs/wp_photos/layer/extend/skin/layer.ext.css*/,
function() {
    layer.ext && layer.ext()
});