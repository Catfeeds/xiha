...
<div class="main">
  ...
  <div class="main-top">
    ...
    <el-button type="success" @click.active.prevent="handleAdd" id="add" data-title="安全员"><i class="el-icon-plus"></i> 安全员</el-button>
  ...
  <div class="main-content">
    <el-table v-loading="loading" element-loading-text="拼命加载中" :data="list" border style="width: 100%;">
      ...
      <el-table-column type="expand">
        <template scope="props">
          <el-form label-position="left">
            ...
            <el-form-item label="安全员统一编号">
              <span>{{ props.row.secunum }}</span>
            </el-form-item>
          </el-form>
        </template>
      </el-table-column>
      <el-table-column prop="secuid" label="ID"></el-table-column>
      ...
      <el-table-column label="操作">
        <template scope="scope">
          <el-button size="small" type="text" data-title="编辑" @click="handleEdit(event, scope.row.secuid, scope.row)">编辑</el-button>
          <el-button size="small" type="text" style="color:#ff4949;" @click.native.prevent="handleDel(event, scope.row.secuid)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
  </div>
