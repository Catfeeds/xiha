    ...
    <el-tabs v-model="activeName">
      <el-tab-pane label="基本信息" name="basicinfo">
        ...
        <el-form-item label="头像" prop="photo" required>
          ...
          :action="upload_examinerimg_url"
          :show-file-list="false"
          :on-success="handleExaminerimgSuccess"
          :before-upload="beforeExaminerimgUpload">
          <img v-if="examinerimgurl" :src="examinerimgurl" class="avatar" />
      ...
      <el-tab-pane label="其他信息" name="otherinfo">
        ...
        <el-form-item label="指纹" prop="fingerprint">
          <el-upload
          class="avatar-uploader"
          :action="upload_examinerfp_url"
          :show-file-list="false"
          :on-success="handleCoachfpSuccess"
          :before-upload="beforeCoachfpUpload">
          <img v-if="examinerfpurl" :src="examinerfpurl" class="avatar" />
          <i v-else class="el-icon-plus avatar-uploader-icon" ></i>
          </el-upload>
        </el-form-item>
      </el-tab-pane>
