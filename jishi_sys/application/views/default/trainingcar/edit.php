...
<script>
    var formEle = {
                ...
                franum:         {value: '<?php echo $franum; ?>',isNull: false,notice: ''},
                engnum:         {value: '<?php echo $engnum; ?>',isNull: false,notice: ''},
                licnum:         {value: '<?php echo $licnum; ?>',isNull: false,notice: ''},
                platecolor:     {value: '<?php echo $platecolor; ?>',isNull: false,notice: ''},
                manufacture:    {value: '<?php echo $manufacture; ?>',isNull: false,notice: ''},
                brand:          {value: '<?php echo $brand; ?>',isNull: false,notice: ''},
                model:          {value: '<?php echo $model; ?>',isNull: false,notice: ''},
                perdritype:     {value: '<?php echo $perdritype; ?>',isNull: false,notice: ''},
                buydate:        {value: '<?php echo $buydate; ?>',isNull: false,notice: ''},
            };
    var vm = new Vue({
        el: "#app",
        data: {
            form: formEle,
            errorClass: 'error',
            base_url: "<?php echo base_url('trainingcar/editajax'); ?>",
        },
        watch: {
        ...
        methods: {
            ...
            validateform: function() {
                if(isNaN(this.form.buydate.value)) {
                    this.form.buydate.isNull = true;
                    this.form.buydate.notice = '日期格式不正确';
                    return false; 
                }
                var params = {
