...
<script>
    var formEle = {
                coachid:        "<?php echo $coachid; ?>",
                coachname:      {title: "<?php echo $name; ?>",isNull: false,notice: ''},
                idcard:         {title: "<?php echo $idcard; ?>",isNull: false,notice: ''},
                sex:            {select: "<?php echo $sex; ?>",isNull: false,notice: ''},
                mobile:         {title: "<?php echo $mobile; ?>",isNull: false,notice: ''},
                address:        {title: "<?php echo $address; ?>"},
                drilicence:     {title: "<?php echo $drilicence; ?>",isNull: false,notice: ''},
                fstdrilicdate:  {title: "<?php echo $fstdrilicdate; ?>",isNull: false,notice: ''},
                occupationno:   {title: "<?php echo $occupationno; ?>",isNull: false,notice: ''},
                occupationlevel:{select: "<?php echo $occupationlevel; ?>",isNull: false,notice: ''},
                dripermitted:   {select: "<?php echo $dripermitted; ?>",isNull: false,notice: ''},
                teachpermitted: {select: "<?php echo $teachpermitted; ?>",isNull: false,notice: ''},
                employstatus:   {select: "<?php echo $employstatus; ?>",isNull: false,notice: ''},
                hiredate:       {title: "<?php echo $hiredate; ?>",isNull: false,notice: ''},
                leavedate:      {title: "<?php echo $leavedate; ?>",isNull: false,notice: ''},
                photo:          {title: '<?php echo $photo; ?>', file_url: ''},
            };
    var vm = new Vue({
        el: "#app",
        data: {
        ...
        methods: {
            ...
            validateform: function() {
                ...
                if( isNaN(this.form.hiredate.title)) {
                    this.form.hiredate.isNull = true;
                    this.form.hiredate.notice = '日期格式不正确';
                    return false; 
                }
                var params = {
