var vm = new Vue({
    ...
    data: {
        ...
        list_url: site_url + 'coach/index',
        add_url: site_url + 'coach/add',
        edit_url: site_url + 'coach/edit',
        detail_url: site_url + 'coach/detail',
        upload_coachimg_url: site_url + 'upload/handle?type=coachimg',
        upload_coachfp_url: site_url + 'upload/handle?type=coachfp'
    },
    created: function() {
        this.ajaxDetail()
    },
    methods: {
        ...
        handleCoachimgSuccess: function(res, file) {
            ...
            if (_.has(res, 'code') && 200 === res.code) {
                ...
                // 缩略图展示
                this.form.coachimgurl = URL.createObjectURL(file.raw);
            } else {
                this.$message({
                    type: 'error',
                    message: res.msg
        ...
        handleCoachfpSuccess: function(res, file) {
            ...
            if (_.has(res, 'code') && 200 === res.code) {
                ...
                // 缩略图展示
                this.form.coachfpurl = URL.createObjectURL(file.raw);
            } else {
                this.$message({
                    type: 'error',
                    message: res.msg
        ...
        reset: function(form) {
            this.form.coachimgurl = ''
            this.form.coachfpurl = ''
