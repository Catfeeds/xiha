var vm = new Vue({
    ...
    data: {
        ...
        edit_url: site_url + 'student/edit',
        detail_url: site_url + 'student/detail',
    ...
    methods: {
        ...
        handleStuimgSuccess: function(res, file) {
            // 缩略图展示
            this.form.stuimgurl = URL.createObjectURL(file.raw);
        ...
        handleStufpSuccess: function(res, file) {
            // 缩略图展示
            this.form.stufpurl = URL.createObjectURL(file.raw);
