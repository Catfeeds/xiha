var vm = new Vue({
    ...
    methods: {
        ...
        handleExaminerimgSuccess: function(res, file) {
            // 获取返回的file_id
            if (_.has(res, 'code') && 200 === res.code) {
                ...
                // 缩略图展示
                this.examinerimgurl = URL.createObjectURL(file.raw);
            } else {
                this.$message({
                    type: 'error',
                    message: res.msg
        ...
        beforeExaminerimgUpload: function(file) {
        ...
        handleCoachfpSuccess: function(res, file) {
            ...
            if (_.has(res, 'code') && 200 === res.code) {
                ...
                // 缩略图展示
                this.examinerfpurl = URL.createObjectURL(file.raw);
            } else {
                this.$message({
                    type: 'error',
                    message: res.msg
