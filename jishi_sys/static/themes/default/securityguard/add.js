    ...
    methods: {
        ...
        handleSecurityguardimgSuccess: function(res, file) {
            ...
            if (_.has(res, 'code') && 200 === res.code) {
                ...
                // 缩略图展示
                this.securityguardimgurl = URL.createObjectURL(file.raw);
            } else {
                this.$message({
                    type: 'error',
                    message: res.msg
        ...
        handleSecurityguardfpSuccess: function(res, file) {
            ...
            if (_.has(res, 'code') && 200 === res.code) {
                ...
                // 缩略图展示
                this.securityguardfpurl = URL.createObjectURL(file.raw);
            } else {
                this.$message({
                    type: 'error',
                    message: res.msg
        ...
        reset: function(form) {
            this.securityguardimgurl = ''
            this.securityguardfpurl = ''
