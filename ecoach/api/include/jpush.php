...
class Jpush {
    ...
    // private $app_key = '3ebbbf7c2e811171a6e5c836';
    // private $master_secret = 'b4272f005b740f30d49a6758';
    // 学员端
    // private $app_key = 'c1b9d554f52b5668cba58c75';        //待发送的应用程序(appKey)，只能填一个。
    // private $master_secret = '68ce861810390d1e88112310';    //主密码
    ...
    **/
    ...
    public function send_pub($receive,$content,$m_type,$m_txt,$m_time){
        $m_type = 'tips';//推送附加字段的类型
        $m_txt = '测试陈锋';//推送附加字段的类型对应的内容(可不填) 可能是url,可能是一段文字。
        $m_time = '86400';//离线保留时间
